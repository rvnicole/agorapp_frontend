...
export function Input({ className, ...rest }: InputProps) {
    return (
        <input
            ...
            selection:text-primary-foreground dark:bg-input/30 border-input h-9 w-full min-w-0 rounded-lg 
            ...
            dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive ${className}`}
            {...rest}
        />
    )
}